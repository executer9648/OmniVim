...
; ~LButton::
; {
; 	global g_doubleLeftClick := (A_PriorHotkey = "~LButton" and A_TimeSincePriorHotkey < 400)
; 	Sleep 0
; 	if g_doubleLeftClick {
; 		StateBulb[StateBulb.MaxBulbs].Create()
; 	}
; 	KeyWait "LButton"  ; This prevents the keyboard's auto-repeat feature from interfering.
; 	StateBulb[StateBulb.MaxBulbs].Destroy()
; }
; #HotIf g_doubleLeftClick
...
; g_doubleRightClick := 0
; ; This detects "double-clicks" of the ctrl key.
; ~RButton::
; {
; 	global g_doubleRightClick := (A_PriorHotkey = "~RButton" and A_TimeSincePriorHotkey < 400)
; 	Sleep 0
; 	if g_doubleRightClick {
; 		StateBulb[StateBulb.MaxBulbs].Create()
; 	}
; 	KeyWait "RButton"  ; This prevents the keyboard's auto-repeat feature from interfering.
; 	StateBulb[StateBulb.MaxBulbs].Destroy()
; }
; #HotIf g_doubleRightClick
